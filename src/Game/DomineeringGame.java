 ...
 * @since 2023-12-01
 */
public class DomineeringGame implements Game {
    /**
    ...
    public void makeMainFrame() {
        ...
        this.btnMainExit.addActionListener(e -> DomineeringGame.this.window.Close());
        this.btnGameWithAgent.addActionListener(e -> {
        ...
        this.btnGameWithPerson.addActionListener(e -> {
            DomineeringGame.this.mainFrame.Close();
            DomineeringGame.this.makeGameFrame();
            Configuration.machine=0;
            DomineeringGame.this.finalizeMainFrame();
        });
        this.btnsauvgardedGamebtn.addActionListener(e -> {
            DomineeringGame.this.mainFrame.Close();
            DomineeringGame.this.makeSauvgardedFrame();
            DomineeringGame.this.finalizeMainFrame();
        });
        this.btnSetting.addActionListener(e -> {
            DomineeringGame.this.mainFrame.Close();
    ...
    public void makeGameFrame() {
        ...
        */
        ...
        Configuration.helpBtn.addActionListener(e -> Configuration.helpPlayer());
        this.goToMainFrameButton.addActionListener(e -> {
        ...
        this.sauvgardebtn.addActionListener(e -> DomineeringGame.this.makeSauvgardeOneGameFrame());
        this.restartGameButton.addActionListener(e -> {
     ...
     */
    @Override
    public void finalizeOneToOneFrame() {
     ...
     */
    @Override
    public void makeSauvgardedFrame(){
     ...
     */
    @Override
    public void makeSauvgardedTable(){
        Configuration.file=StringTableFile.getInstance();
     ...
     */
    @Override
    public void makeSauvgardeOneGameFrame(){
        if(DomineeringGame.this.oneToOneGameFrame!=null){
            if(DomineeringGame.this.sauvgardeFrame==null){
                ...
                DomineeringGame.this.refuseSauvgarde.addActionListener(e -> {
                    DomineeringGame.this.oneToOneGameFrame.Close();
                    DomineeringGame.this.sauvgardeFrame.Close();
                    DomineeringGame.this.sauvgardeFrame=null;
                    DomineeringGame.this.oneToOneGameFrame.Show();
                });
                DomineeringGame.this.submitSauvgarde.addActionListener(e -> {
                    DomineeringGame.this.oneToOneGameFrame.Close();
                    Configuration.file=StringTableFile.getInstance();
    ...
    public void makeSettingFrame(){
        ...
        this.saveSetting.addActionListener(e -> {
     ...
     */
    @Override
    public void finalizeSettingFrame(){
